...
> Design notes for **legaltech-rerank-service** — a runnable typescript example that Typed TypeScript service for reranking legal-tech intake work.
...
- **Feature code** — the actual task: legal search reranking.
